           ...
           <div className="container mx-auto px-4 sm:px-8">
            <div className="py-8">
                <div className='px-2 flex justify-between'>
                    ...
                    <Link href="/admin/categories/add"><h2 className="text-lg font-semibold leading-tight bg-blue-900 text-white rounded-full shadow px-5 py-1">Add Category</h2></Link> 
                </div>
                <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                        <table className="min-w-full m leading-normal ">
                            ...
                            <tbody>
                                {!category?"loading":category.map((data,index)=>{
                                    return <tr key={index+1}>
                                        ...
                                        <td className="text-center px-5 py-5 bg-white text-sm">
                                            <span onClick={()=>router.push(`/admin/categories/${data.id}`)} className="mr-3 relative inline-block px-3 py-1 font-semibold text-yellow-900 leading-tight">
