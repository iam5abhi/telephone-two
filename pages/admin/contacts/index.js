           ...
           <div className="container mx-auto px-4 sm:px-8">
            <div className="py-8">
                <div className='px-2 flex justify-between'>
                    ...
                    <Link href="/admin/contacts/add" ><h2 className="text-lg font-semibold leading-tight bg-blue-900 text-white rounded-full shadow px-5 py-1">Add Contacts</h2></Link>
                </div>
